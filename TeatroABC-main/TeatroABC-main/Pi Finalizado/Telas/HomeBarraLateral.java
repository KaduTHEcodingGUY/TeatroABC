...
public class HomeBarraLateral {
    ...
    private BorderPane createSidebar(Stage primaryStage) { 
        ...
        Button btnComprar = createNavButtonWithIcon("Comprar Ingressos", "/Utilitarios/ticket.png", new TelaCompraIngresso());
        ...
        Button btnClube = createNavButtonWithIcon("Clube Fidelidade", "/Utilitarios/club (1).png", new ClubeFidelidade());
