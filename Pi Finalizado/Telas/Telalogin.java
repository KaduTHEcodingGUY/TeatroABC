...
public class Telalogin {
   ...
   private ImageView createBackgroundImage() {
    ...
    private VBox createLoginForm(Stage primaryStage) {
        ...
        // MODIFICADO: Ação do link de cadastro
        cadastroHlink.setOnAction(e -> {
            ...
            Parent cadastroRoot = telaCadastro.getRoot(primaryStage);
            
            // Cria a nova cena com as dimensões exatas da janela
            Scene cadastroScene = new Scene(cadastroRoot, currentWidth, currentHeight);
            
            primaryStage.setScene(cadastroScene);
            // REMOVIDO: primaryStage.setMaximized(true); não é mais necessário
        });
        ...
        // MODIFICADO: Ação do botão de login
        loginButton.setOnAction(e -> {
            ...
            if (Backend.Servicos.AuthService.signIn(email, password)) {
                ...
                alert.setOnHidden(evt -> {
                    ...
                    // Cria a nova cena com as dimensões exatas da janela
                    Scene scene = new Scene(rootWithSidebar, currentWidth, currentHeight);
