...
public class MapaAssentos implements ProvedorView {
    ...
    private VBox createSidebar(MapaAssentos viewManager) {
        ...
        //LÓGICA DE VALIDAÇÃO DE FIDELIDADE 
        ...
        for (Setor setor : setores) {
            //Passa o status de fidelidade para o método de criação do botão
    ...
    //Método agora recebe o status de fidelidade para calcular o preço
    private VBox createSetorOption(String id, String nome, String precoStr, MapaAssentos viewManager, boolean isMembroFidelidade) {
        ...
        // Lógica para aplicar o desconto no label
        ...
        // 2. Aplica o estilo de selecionado no VBox que foi clicado
        container.setStyle(STYLE_SETOR_SELECIONADO);

        // 3. Atualiza a referência para o VBox atualmente selecionado
    ...
    public void updateMap(String newAreaId, String newSubCategory, String areaName) {
        ...
        // Imagem do palco com largura reduzida
